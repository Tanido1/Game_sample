...
[tb_eval  exp="f.hour=18"  name="hour"  cmd="="  op="t"  val="18"  val_2="undefined"  ]
[tb_eval  exp="f.minute=0"  name="minute"  cmd="="  op="t"  val="0"  val_2="undefined"  ]
[tb_eval  exp="f.nextHour=18"  name="nextHour"  cmd="="  op="t"  val="18"  val_2="undefined"  ]
[jump  storage="scene12.ks"  target="*common0"  cond="f.hinanFlag=='false'"  ]
[jump  storage="scene12.ks"  target="*common0"  cond="f.LBFlag>900"  ]
...
[jump  storage="scene12.ks"  target="*common1"  ]
*common0
...
[jump  storage="scene12.ks"  target="*nextScene"  cond="f.hinanFlag=='true'"  ]
[glink  color="black"  storage="scene12.ks"  size="20"  text="避難する"  y="300"  x="100"  target="*hinanNow"  ]
[glink  color="black"  storage="scene12.ks"  size="20"  text="避難しない"  x="300"  y="300"  target="*common2"  ]
...
[jump  storage="scene12.ks"  target="*hinan"  ]
*common2

[tb_eval  exp="f.now='false'"  name="now"  cmd="="  op="t"  val="false"  val_2="undefined"  ]
[glink  color="black"  storage="scene12.ks"  size="20"  text="ネットで情報を見る"  target="*net"  x="217"  y="274"  width=""  height=""  _clickable_img=""  ]
[glink  color="black"  storage="scene12.ks"  size="20"  text="待つ"  target="*nextScene"  x="760"  y="271"  width=""  height=""  _clickable_img=""  ]
[tb_start_text mode=4 ]
...
[glink  color="black"  storage="scene12.ks"  size="20"  text="避難する"  y="300"  x="100"  target="*hinan"  ]
[glink  color="black"  storage="scene12.ks"  size="20"  text="避難しない"  x="300"  y="300"  target="*nextScene"  ]
[tb_start_text mode=4 ]
避難しますか？
[_tb_end_text]
...
[jump  storage="scene12.ks"  target="*common2"  cond="f.now=='true'"  ]
*nextScene
