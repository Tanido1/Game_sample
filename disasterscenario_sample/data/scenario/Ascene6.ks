[_tb_system_call storage=system/_Ascene6.ks]
...
[tb_start_tyrano_code]
千曲川生田観測所より[tip key="floodAdvisory" color=0xffff00 entercolor=0x00ffff mark=true] 氾濫注意情報[endtip]
[_tb_end_tyrano_code]
...
[glink  color="black"  storage="scene6.ks"  size="20"  text="県単位"  target="*選択肢2"  x="100"  y="300"  ]
[glink  color="black"  storage="scene6.ks"  size="20"  text="市区町村単位"  target="*選択肢1"  x="500"  y="300"  ]
[glink  color="black"  storage="scene6.ks"  size="20"  text="地区単位"  target="*選択肢2"  x="900"  y="300"  ]
...
[glink  color="black"  storage="scene6.ks"  size="20"  text="待つ"  target="*nextScene"  x="760"  y="271"  width=""  height=""  _clickable_img=""  ]
[tb_start_text mode=4 ]
