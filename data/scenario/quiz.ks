...
[glink  color="black"  storage="quiz.ks"  size="20"  text="0.5~3ｍ未満（1階床上~軒下浸水）"  target="*選択肢1"  x="100"  y="300"  ]
[glink  color="black"  storage="quiz.ks"  size="20"  text="3ｍ以上（2階床上~）"  target="*選択肢2"  x="500"  y="300"  ]
...
[tb_image_show  time="1000"  storage="default/浸水リスク解説.png"  width="1280"  height="486"  x="670"  y="-102"  _clickable_img=""  name="img_18"  ]
...
避難方法としては，立ち退き避難の必要があります．TIPS参照．[p]
また，指定緊急避難所などへ避難は原則徒歩です．避難方法などに関する一般的な情報は内閣府のホームページや政府広報オンラインなど見られます．[p]
[_tb_end_text]
...
内閣府のホームページは避難情報に関する情報が掲載されています．[p]
