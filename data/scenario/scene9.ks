...
[tb_eval  exp="f.hour=15"  name="hour"  cmd="="  op="t"  val="15"  val_2="undefined"  ]
[tb_eval  exp="f.minute=30"  name="minute"  cmd="="  op="t"  val="30"  val_2="undefined"  ]
[tb_eval  exp="f.nextHour=16"  name="nextHour"  cmd="="  op="t"  val="16"  val_2="undefined"  ]
[jump  storage="scene9.ks"  target="*common0"  cond="f.hinanFlag=='false'"  ]
[jump  storage="scene9.ks"  target="*common0"  cond="f.LBFlag>900"  ]
...
[jump  storage="scene9.ks"  target="*common1"  ]
*common0
...
[tb_ptext_show  x="10"  y="10"  size="30"  color="0x000000"  time="1000"  text="2021/10/12/15:30"  anim="false"  face="undefined"  edge="0xffffff"  shadow="undefined"  ]
[tb_start_tyrano_code]
[tip key="tokubetsukeiho" color=0xffff00 entercolor=0x00ffff mark=true]大雨特別警報（浸水害）[endtip]
[_tb_end_tyrano_code]
...
[jump  storage="scene9.ks"  target="*hinan"  ]
*common2

[tb_eval  exp="f.now='false'"  name="now"  cmd="="  op="t"  val="false"  val_2="undefined"  ]
[glink  color="black"  storage="scene9.ks"  size="20"  text="ネットで情報を見る"  target="*net"  x="217"  y="274"  width=""  height=""  _clickable_img=""  ]
[glink  color="black"  storage="scene9.ks"  size="20"  text="待つ"  target="*nextScene"  x="760"  y="271"  width=""  height=""  _clickable_img=""  ]
[tb_start_text mode=4 ]
...
[glink  color="black"  storage="scene9.ks"  size="20"  text="避難する"  y="300"  x="100"  target="*hinan"  ]
[glink  color="black"  storage="scene9.ks"  size="20"  text="避難しない"  x="300"  y="300"  target="*nextScene"  ]
[tb_start_text mode=4 ]
避難しますか？
[_tb_end_text]
...
[jump  storage="scene9.ks"  target="*common2"  cond="f.now=='true'"  ]
*nextScene
