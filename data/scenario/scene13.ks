...
[tb_eval  exp="f.minute=1"  name="minute"  cmd="="  op="t"  val="1"  val_2="undefined"  ]
[tb_eval  exp="f.nextHour=18"  name="nextHour"  cmd="="  op="t"  val="18"  val_2="undefined"  ]
[jump  storage="scene13.ks"  target="*common0"  cond="f.hinanFlag=='false'"  ]
[jump  storage="scene13.ks"  target="*common0"  cond="f.LBFlag>900"  ]
...
[jump  storage="scene13.ks"  target="*common1"  ]
*common0
...
[jump  storage="scene13.ks"  target="*hinan"  ]
*common2
...
[glink  color="black"  storage="scene13.ks"  size="20"  text="避難する"  y="300"  x="100"  target="*hinan"  ]
[glink  color="black"  storage="scene13.ks"  size="20"  text="避難しない"  x="300"  y="300"  target="*nextScene"  ]
[tb_start_text mode=4 ]
避難しますか？
[_tb_end_text]
...
[jump  storage="scene13.ks"  target="*common2"  cond="f.now=='true'"  ]
*nextScene
